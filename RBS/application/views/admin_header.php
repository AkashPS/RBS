...
<body class="animsition">
        ...
        <aside class="menu-sidebar d-none d-lg-block">
            <div class="logo">
                <a href="<?php echo site_url("Rbsctrl/admin_home1")?>">
                    <img src="<?php echo base_url(); ?>img/core-img/rbslogo.png" alt="Admin" />
                </a>
            </div>
            <div class="menu-sidebar__content js-scrollbar1">
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li>
                            <a href="<?php echo site_url("Rbsctrl/view_owners")?>">
                                <i class="fas fa-table"></i>Owners</a>
                        </li>
                        <li>
                            <a href="<?php echo site_url("RBSctrl/dispdata")?>">
                                <i class="fas fa-table"></i>Customer</a>
                        </li>
                        <li>
                            <a href="<?php echo site_url("RBSctrl/owner_request")?>">
                                <i class="fas fa-table"></i>Owner Request</a>
                        </li>
                        <li>
                            <a href="<?php echo site_url("RBSctrl/hotellist")?>">
                                <i class="fas fa-table"></i>Hotel list</a>
                        </li>
                        <li>
                            <a href="<?php echo site_url("RBSctrl/admincard")?>">
                                <i class="fas fa-table"></i>Card details</a>
                        </li>
                        <li>
                            <a href="<?php echo site_url("RBSctrl/email")?>">
                                <i class="fas fa-table"></i>email</a>
                        </li>
                    ...
                    <div class="container-fluid">
                        <div class="header-wrap">
                            ...
                            <div class="header-button">
                                ...
                                <div class="account-wrap" align="">
                                    <div class="account-item clearfix js-item-menu">
                                        <div class="image">
                                            <img src="<?php echo base_url(); ?>img/core-img/admin.png" alt="Admin" />
                                        </div>
                                        <div class="content">
                                        ...
                                        <div class="account-dropdown js-dropdown">
                                            <div class="info clearfix">
                                                ...
                                                <div class="content">
                                                    ...
                                                    <span class="email">admin@.com</span>
                                                </div>
                                            </div>

                                            <div class="account-dropdown__footer">
                                                <a href="<?php echo site_url("Rbsctrl/logout") ?> ">
