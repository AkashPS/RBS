                ...
                <div class="row">
                    <div class="col-12 col-lg-8">
                        <div class="checkout_details_area mt-50 clearfix">
                            ...
                            <form action="<?php echo site_url("Rbsctrl/register_cust")?>" method="post" class="cv-form">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        <input type="tel" class=" cv-mobile form-control" name="mobile" cv-message="Invalid monile number"  placeholder="Phone No" pattern="[789][0-9]{9}" maxlength="10" value="" required="chech the name filed">
                                    </div>
                                    
                                    <div class="col-12 mb-3">
                                        <input type="email" class="cv-email form-control" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" required="check mail field" cv-message="Invalid email address" name="email" placeholder="Email" value="">
                                    </div>
                                    <div class="col-12 mb-3">
