...
?>
<!-- <h1 align="center"> accomadation</h1> -->
<br><br><br>
                                ...
                                <div class="overview-item overview-item--c1">
                                    <div class="overview__inner">
                                        ...
                                        <div class="overview-chart"><div class="chartjs-size-monitor" style="position: absolute; left: 0px; top: 0px; right: 0px; bottom: 0px; overflow: hidden; pointer-events: none; visibility: hidden; z-index: -1;"><div class="chartjs-size-monitor-expand" style="position:absolute;left:0;top:0;right:0;bottom:0;overflow:hidden;pointer-events:none;visibility:hidden;z-index:-1;"><div style="position:absolute;width:1000000px;height:1000000px;left:0;top:0"></div></div><div class="chartjs-size-monitor-shrink" style="position:absolute;left:0;top:0;right:0;bottom:0;overflow:hidden;pointer-events:none;visibility:hidden;z-index:-1;"><div style="position:absolute;width:200%;height:200%;left:0; top:0"></div></div></div>
                                            <canvas id="widgetChart1" height="130" width="187" class="chartjs-render-monitor" style="display: block; width: 187px; height: 130px;"></canvas>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="overview-item overview-item--c4">
                                    <div class="overview__inner">
                                        <div class="overview-box clearfix">
                                            ...
                                            <div class="text">
                                            <li><a href="<?php echo site_url('Rbsctrl/testpage')?>">
<img src="<?php echo base_url(); ?>img/core-img/hotel.png" height="150" width="150"></a></li>
                                            </div>
                                        </div>
                                        <div class="overview-chart"><div class="chartjs-size-monitor" style="position: absolute; left: 0px; top: 0px; right: 0px; bottom: 0px; overflow: hidden; pointer-events: none; visibility: hidden; z-index: -1;"><div class="chartjs-size-monitor-expand" style="position:absolute;left:0;top:0;right:0;bottom:0;overflow:hidden;pointer-events:none;visibility:hidden;z-index:-1;"><div style="position:absolute;width:1000000px;height:1000000px;left:0;top:0"></div></div><div class="chartjs-size-monitor-shrink" style="position:absolute;left:0;top:0;right:0;bottom:0;overflow:hidden;pointer-events:none;visibility:hidden;z-index:-1;"><div style="position:absolute;width:200%;height:200%;left:0; top:0"></div></div></div>
                                            <canvas id="widgetChart4" height="115" width="187" class="chartjs-render-monitor" style="display: block; width: 187px; height: 115px;"></canvas>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<div class="" " height="42" width="42">

<!-- <li><a href="<?php echo site_url('Rbsctrl/home_reg')?>">
<img src="<?php echo base_url(); ?>img/core-img/home.png" height="150" width="150"></a></li>


<li><a href="<?php echo site_url('Rbsctrl/hostel_reg')?>">
<img src="<?php echo base_url(); ?>img/core-img/hostel.png"  height="150" width="150"></a></li> -->

<!-- <li><a href="<?php echo site_url('Rbsctrl/testpage')?>">
<img src="<?php echo base_url(); ?>img/core-img/hotel.png" height="150" width="150"></a></li> -->

<!-- <li><a href="<?php echo site_url('Rbsctrl/pg_reg')?>">
<img src="<?php echo base_url(); ?>img/core-img/pg.png"  height="150" width="150"></a></li>
</div> -->
