...
<body class="animsition">
        ...
        <aside class="menu-sidebar d-none d-lg-block">
            <div class="logo">
                <a href="<?php echo site_url('Rbsctrl/ownerhome') ?>">
                    <!-- <img src="<?php echo base_url(); ?>images/icon/a.png" alt="Cool Admin" /> -->
                    <h1>RBS</h1>
                </a>
            </div>
            <div class="menu-sidebar__content js-scrollbar1">
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li>
                            <a href="<?php echo site_url('Rbsctrl/accomadation') ?>">
                                <i class="fas fa-group"></i>Accomodation</a>


                        </li>
                        <li>
                            <a href="<?php echo site_url('Rbsctrl/ownerprofile') ?>">
                            ...
                            <div class="header-button">
                                ...
                                <div class="account-wrap">
                                    <div class="account-item clearfix js-item-menu">
                                        ...
                                        <div class="content">
                                            <a class="js-acc-btn" href="#">Owner</a>
                                        </div>
