...
<body class="animsition">
        ...
        <aside class="menu-sidebar d-none d-lg-block">
            <div class="logo">
                <a href="<?php echo site_url("Custctrl/cust_home")?>">
                    <img src="<?php echo base_url(); ?>img/core-img/rbslogo.png" alt="Customer" />
                </a>
            </div>
            <div class="menu-sidebar__content js-scrollbar1">
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li>
                            <a href="<?php echo site_url("Custctrl/hotels")?>">
                                <i class="fas fa-table"></i>Hotels</a>
                        </li>
                        <!-- <li>
