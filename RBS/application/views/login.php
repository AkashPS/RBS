...
<body>
    ...
    <div class="main-content-wrapper d-flex clearfix">
        ...
        <header class="header-area clearfix">
            ...
            <!-- Logo -->
            <div class="logo">
                <a href="<?php echo site_url('Rbsctrl/home')?>"><img src="<?php echo base_url(); ?>img/core-img/logo.jpg" alt=""></a>
            </div>
            <!-- Amado Nav -->
            <nav class="amado-nav">
                <ul>
                    
                <li><a href="<?php echo site_url('Rbsctrl/index')?>"><h5>Back to Home</h5></a></li>
                    <!-- <li><a href="#">Shop</a></li>
                ...
                <div class="row">
                    <div class="col-12 col-lg-8">
                        <div class="checkout_details_area mt-50 clearfix">
                            ...
                            <form action="<?php echo site_url('Rbsctrl/loginn')?>" class="oh-autoval-form" method="post">
                                <div class="row">
                                   
                                    <div class="col-12 mb-3">
                                        <input type="email" class=" av-email form-control" av-message="Invalid email address" name="email" placeholder="Email" value="">
                                    </div>
                                    <div class="col-12 mb-3">
